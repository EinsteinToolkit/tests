...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/tests/tests/arrangements/ExternalLibraries/SGRID/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
...
\begin{abstract}
This thorn provides the SGRID library, which can be used to read binary
neutron star initial data produced by SGRID.
\end{abstract}

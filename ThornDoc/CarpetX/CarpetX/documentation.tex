...
%    \begin{figure}[ht]
% 	\begin{center}
%    	   \includegraphics[width=6cm]{/home/runner/work/tests/tests/arrangements/CarpetX/CarpetX/doc/MyArrangement_MyThorn_MyFigure}
% 	\end{center}
...
\begin{figure*}[ht]
    \begin{center}
        \includegraphics[width=6cm]{/home/runner/work/tests/tests/arrangements/CarpetX/CarpetX/doc/logo.png}
    \end{center}
    \label{fig:logo}
\end{figure*}
...
\begin{figure*}[ht]
  \begin{center}
      \includegraphics[width=\linewidth]{/home/runner/work/tests/tests/arrangements/CarpetX/CarpetX/doc/boxes_frames.png}
  \end{center}
...
\vspace{0.5cm}\noindent \begin{tabular*}{\tableWidth}{|c|l@{\extracolsep{\fill}}r|}
\hline
\multicolumn{1}{|p{\maxVarWidth}}{out\_tsv\_combine\_iterations} & {\bf Scope:} private & BOOLEAN \\\hline
\multicolumn{3}{|p{\descWidth}|}{{\bf Description:}   {\em Combine all iterations into a single TSV file}} \\
\hline & & {\bf Default:} no \\\hline
\end{tabular*}
...
\vspace{0.5cm}\noindent \begin{tabular*}{\tableWidth}{|c|l@{\extracolsep{\fill}}r|}
\hline
\multicolumn{1}{|p{\maxVarWidth}}{out\_tsv\_header} & {\bf Scope:} private & KEYWORD \\\hline
\multicolumn{3}{|p{\descWidth}|}{{\bf Description:}   {\em How to output TSV column header}} \\
\hline{\bf Range} & &  {\bf Default:} comment \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering none} & \multicolumn{2}{p{\paraWidth}|}{no header} \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering comment} & \multicolumn{2}{p{\paraWidth}|}{as comment (for backward compatibility)} \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering plain} & \multicolumn{2}{p{\paraWidth}|}{plain TSV header} \\\hline
\end{tabular*}

\vspace{0.5cm}\noindent \begin{tabular*}{\tableWidth}{|c|l@{\extracolsep{\fill}}r|}
\hline
\multicolumn{1}{|p{\maxVarWidth}}{out\_tsv\_output\_boundary\_points} & {\bf Scope:} private & BOOLEAN \\\hline
\multicolumn{3}{|p{\descWidth}|}{{\bf Description:}   {\em Output outer boundary points in 1d TSV files}} \\
\hline & & {\bf Default:} yes \\\hline
\end{tabular*}

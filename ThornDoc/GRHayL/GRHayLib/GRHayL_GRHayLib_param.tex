...
\settowidth{\maxVarWidth}{enable\_backup\_nn\_primitive\_guess}
...
f/astro-ph/0512420.p 
df, but uses the entropy"} \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering Noble1D\_entropy2} & \multicolumn{2}{p{\paraWidth}|}{"1D rho routine for constant-Gamma EOS (neos=1 and Gamma\_th=Gamma\_ppoly 
\_in[0]), using the entropy and momentum equation"} \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering Font1D} & \multicolumn{2}{p{\paraWidth}|}{TODO} \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering Palenzuela1D} & \multicolumn{2}{p{\paraWidth}|}{"https://arxiv.org/p 
...
\vspace{0.5cm}\noindent {\bf [1]} \noindent \begin{verbatim}Palenzuela1D\_entropy\end{verbatim}\noindent \begin{tabular*}{\tableWidth}{|c|l@{\extracolsep{\fill}}r|}
\hline
\multicolumn{1}{|p{\maxVarWidth}}{enable\_backup\_nn\_primitive\_guess} & {\bf Scope:} restricted & BOOLEAN \\\hline
\multicolumn{3}{|p{\descWidth}|}{{\bf Description:}   {\em Do we want a backup primitive guess using neural networks in Con2Prim?}} \\
\hline{\bf Range} & &  {\bf Default:} no \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering no} & \multicolumn{2}{p{\paraWidth}|}{Do not use neural-network primitive guess.} \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering yes} & \multicolumn{2}{p{\paraWidth}|}{Use neural-network primitive guess if default guess fails.} \\\hline
\end{tabular*}

\vspace{0.5cm}\noindent \begin{tabular*}{\tableWidth}{|c|l@{\extracolsep{\fill}}r|}
\hline
\multicolumn{1}{|p{\maxVarWidth}}{eos\_table\_clean\_sound\_speed} & {\bf Scope:} restricted & BOOLEAN \\\hline
\multicolumn{3}{|p{\descWidth}|}{{\bf Description:}   {\em Whether or not to clean the tabulated sound speed squared.}} \\
\hline{\bf Range} & &  {\bf Default:} no \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering no} & \multicolumn{2}{p{\paraWidth}|}{Do not clean/adjust the tabulated sound speed squared.} \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering yes} & \multicolumn{2}{p{\paraWidth}|}{Clean/adjust the tabulated sound speed squared (NAN/INF -{\textgreater} 1, cs2 {\textgreater} 1 -{\textgreater} 1, cs2 {\textless} 0 -{\textgreater} 0).} \\\hline
\end{tabular*}

\vspace{0.5cm}\noindent \begin{tabular*}{\tableWidth}{|c|l@{\extracolsep{\fill}}r|}
\hline
\multicolumn{1}{|p{\maxVarWidth}}{eos\_table\_type} & {\bf Scope:} restricted & KEYWORD \\\hline
\multicolumn{3}{|p{\descWidth}|}{{\bf Description:}   {\em The type of EOS table for the simulation}} \\
\hline{\bf Range} & &  {\bf Default:} stellarcollapse \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering stellarcollapse} & \multicolumn{2}{p{\paraWidth}|}{"Table format from Stellar Collapse (stellarcollapse.org 
)"} \\\hline
\end{tabular*}
...
\hline{\bf Range} & &  {\bf Default:} -1 \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering 1:*} & \multicolumn{2}{p{\paraWidth}|}{{\textgreater} 1; GRHayLib\_paramcheck rejects 1 and non-finite values.} \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering -1} & \multicolumn{2}{p{\paraWidth}|}{forbidden value to make sure it is explicitly set in the parfile} \\\hline
\end{tabular*}
...
\hline{\bf Range} & &  {\bf Default:} 10.0 \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering 1:*} & \multicolumn{2}{p{\paraWidth}|}{{\textgreater}= 1; GRHayLib\_paramcheck separately requires a finite value.} \\\hline
\end{tabular*}

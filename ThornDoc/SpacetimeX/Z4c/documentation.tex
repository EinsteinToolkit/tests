...
~& ~ &betag(everywhere)\\ 
~& ~ &chi\_rhs(everywhere)\\ 
~& ~ &gamma\_tilde\_rhs(everywhere)\\ 
~& ~ &k\_hat\_rhs(everywhere)\\ 
~& ~ &a\_tilde\_rhs(everywhere)\\ 
~& ~ &gam\_tilde\_rhs(everywhere)\\ 
~& ~ &theta\_rhs(everywhere)\\ 
~& ~ &alphag\_rhs(everywhere)\\ 
~& ~ &betag\_rhs(everywhere)\\ 
~ & Type:  & function \\ 
~ & Writes:  & chi\_rhs(interior) \\ 
~& ~ &gamma\_tilde\_rhs(interior)\\ 
~& ~ &k\_hat\_rhs(interior)\\ 

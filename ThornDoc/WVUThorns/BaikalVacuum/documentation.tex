...
\hline{\bf Range} & &  {\bf Default:} 4 \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering 4:4} & \multicolumn{2}{p{\paraWidth}|}{"finite-differencing 
 order = 4"} \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering 6:6} & \multicolumn{2}{p{\paraWidth}|}{"finite-differencing 
 order = 6"} \\\multicolumn{1}{|p{\maxVarWidth}|}{\centering 8:8} & \multicolumn{2}{p{\paraWidth}|}{"finite-differencing 
 order = 8"} \\\hline
\end{tabular*}

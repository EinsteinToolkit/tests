...
# TODO: parse args containing paths to $WORKSPACE/MASTER and $WORKSPACE/GH-PAGES when calling create_csv.py
...
with open('docs/version.txt', 'w') as verfile:
    print("\n".join([str(build) for build in list_of_builds]), file=verfile) #join accepts str, not int 

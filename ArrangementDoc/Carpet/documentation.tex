...
%    \begin{figure}[ht]
%       \begin{center}
%          \includegraphics[width=6cm]{/home/runner/work/tests/tests/arrangements/Carpet/doc/MyArrangement_MyThorn_MyFigure}
%       \end{center}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[scale=0.5]{/home/runner/work/tests/tests/arrangements/Carpet/doc/Grid1}
...
\item {\bf I want to run with periodic boundaries. Why aren't things
  ...
  \begin{figure}[htbp]
    \begin{center}
      \includegraphics[scale=0.5]{/home/runner/work/tests/tests/arrangements/Carpet/doc/Periodic1}
  ...
  \begin{figure}[htbp]
    \begin{center}
      \includegraphics[scale=0.5]{/home/runner/work/tests/tests/arrangements/Carpet/doc/Periodic2}
